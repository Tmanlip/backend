...
@section('heading', 'Welcome to ASLAW')
...
@section('content')
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px 0;">
        <tr>
            <td>
                <a href="{{ $loginUrl }}" style="display:inline-block;padding:14px 24px;border-radius:10px;background-color:#0f172a;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;">Log In to ASLAW</a>
            </td>
        </tr>
    </table>
    ...
    <p style="margin:0;">If the button does not work, open this link in your browser: <span style="color:#1d4ed8;word-break:break-all;">{{ $loginUrl }}</span></p>
@endsection
