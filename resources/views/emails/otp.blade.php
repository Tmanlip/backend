...
@section('preheader', 'Use your ASALAW verification code to complete sign in.')
@section('heading', 'Your Verification Code')

@section('content')
    <p style="margin:0 0 16px 0;">Hello,</p>
    <p style="margin:0 0 20px 0;">Use the verification code below to continue your ASALAW sign-in request.</p>
